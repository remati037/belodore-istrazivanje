---
description: Faza 9 · Finalni izveštaj, verzija za prezentaciju i propratni email
allowed-tools: Read, Write, Edit, WebSearch, WebFetch, Bash
---

PREDUSLOV: faza 8 završena i ispravke unete u dokumente faza.
Pročitaj sve iz `01-faze/`, `04-izvori/registar-izvora.md` i
`03-isporuke/checklist-isporuka.md`.

Kompajluj sve nalaze u finalni izveštaj istraživanja tržišta za KLAUDS (kontekst u
CLAUDE.md). Čitaoci: menadžment i vlasnik kompanije, interno. Ton: direktan i radni,
ne "pitch". NE uvodi nove tvrdnje — samo organizuj, sažmi i izoštri postojeće.
...
5. Odvojeno napravi VERZIJU ZA PREZENTACIJU: 10–12 slajdova (naslov + 3–5 bulleta po
   slajdu, bez sitnog teksta), sa predlogom šta ide na koji slajd.
...
Napomena za konverziju u Word/PDF: kad izveštaj bude gotov, mogu ga konvertovati
komandom `/u-docx` (traži pandoc) ili ga ručno prekopiraj u Word.
